"use strict";(self.webpackChunkdurians=self.webpackChunkdurians||[]).push([[923],{26520:function(L,r,t){t.r(r),t.d(r,{default:function(){return j}});var v=t(5574),h=t.n(v),b=t(97857),P=t.n(b),a=t(67294),n=t(53683),F=t(56790),S=t(64236),i={TablePro:{type:"COMPONENT",id:"TablePro",title:"TablePro",propsConfig:{type:"object",required:[],className:"__type",properties:{ajax:{type:"function",className:"Function",description:"\u901A\u7528ajax\u5B9E\u73B0\u65B9\u6CD5",tags:{description:"\u901A\u7528ajax\u5B9E\u73B0\u65B9\u6CD5",default:`(url: string, params: object, callback: Function, isApi = true) => {
let api_ = "";
if (isApi) {
api_ = "api";
}
